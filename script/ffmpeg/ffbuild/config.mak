...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cross-prefix=/usr/bin/aarch64-linux-gnu- --enable-pthreads --enable-cross-compile --target-os=linux --arch=aarch64 --enable-shared --enable-network --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --enable-demuxer=rtsp --disable-debug --disable-stripping --disable-doc --disable-ffplay --disable-ffprobe --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-w32threads --disable-os2threads --prefix=/home/ascend/AscendProjects/sample-videoanalysiscar/script/ffmpeg/install_path
prefix=/home/ascend/AscendProjects/sample-videoanalysiscar/script/ffmpeg/install_path
...
CC_IDENT=gcc 5.4.0 (Ubuntu/Linaro 5.4.0-6ubuntu1~16.04.9) 20160609
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=
...
OBJCC=/usr/bin/aarch64-linux-gnu-gcc
LD=/usr/bin/aarch64-linux-gnu-gcc
DEPCC=/usr/bin/aarch64-linux-gnu-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/usr/bin/aarch64-linux-gnu-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
ARFLAGS=rcD
AR_O=$@
AR_CMD=/usr/bin/aarch64-linux-gnu-ar
NM_CMD=/usr/bin/aarch64-linux-gnu-nm -g
RANLIB=/usr/bin/aarch64-linux-gnu-ranlib -D
...
LD_PATH=-L
DLLTOOL=
WINDRES=/usr/bin/aarch64-linux-gnu-windres
DEPWINDRES=/usr/bin/aarch64-linux-gnu-gcc
DOXYGEN=doxygen
