...
1.  部署，可以选择如下快速部署或者常规方法部署，二选一即可；
    ...
    >-   该快速部署脚本可以快速部署多个案例，请选择车牌识别案例部署即可。  
    >-   该快速部署脚本自动完成了代码下载、模型转换、环境变量配置等流程，如果需要了解详细的部署过程请选择常规部署方式，请转**1.2 常规部署**。

    1.2 常规部署，请参考：https://gitee.com/Atlas200DK/sample-README/tree/master/sample-carplaterecognition 。
...
1.  打开对应的工程。
    ...
    **图 1**  打开sample-carplaterecognition工程<a name="fig721144422212"></a>  
...
2.  在src/param\_configure.conf文件中配置相关工程信息。
    ...
    **图 2**  配置文件路径<a name="fig1557065718252"></a>  
...
3.  开始编译，打开Mind Studio工具，在工具栏中点击**Build \> Build \> Build-Configuration**。如[图4](#fig13819202814301)所示，会在目录下生成build和run文件夹。

    **图 4**  编译操作及生成文件<a name="fig13819202814301"></a>  
...
1.  运行车牌识别应用程序
    ...
    在Mind Studio工具的工具栏中找到Run按钮，点击**Run \> Run 'sample-carplaterecognition'**，如[图10](#fig12953163061713)所示，可执行程序已经在开发板执行。
...
-   **停止车牌识别应用**
    ...
    **图 12**  停止车牌识别应用<a name="fig14326454172518"></a>  
    ...
    **图 13**  车牌识别应用已停止<a name="fig2182182518112"></a>  
